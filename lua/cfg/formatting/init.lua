	...
	cpp = {
		function()
			return {
				exe = "clang-format",
				args = {
					"-style='{BasedOnStyle: google, IndentWidth: 4, AccessModifierOffset: -4, BreakBeforeBraces: Linux, AllowShortFunctionsOnASingleLine: None}' --assume-filename",
	...
	arduino = {
		function()
			return {
				exe = "clang-format",
				args = {
					"-style='{BasedOnStyle: google, IndentWidth: 4, AccessModifierOffset: -4}' --assume-filename",
					vim.api.nvim_buf_get_name(0),
				},
				stdin = true,
				cwd = vim.fn.expand("%:p:h"),
